...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
    ...
    <?php $form = ActiveForm::begin(['id' => 'ddFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['nt-dtr/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['nt-dtr/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
