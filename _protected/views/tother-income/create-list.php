...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
    ...
    <?php $form = ActiveForm::begin(['id' => 'totherFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['tother-income/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['tother-income/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
