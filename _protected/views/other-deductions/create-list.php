...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
    ...
    <?php $form = ActiveForm::begin(['id' => 'odeducFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['other-deductions/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['other-deductions/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
