...
$this->title = 'Employee List for Other Deductions';
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'create' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="glyphicon glyphicon-plus"></span>',$url,
                          [
                              'title' => 'Add-Other-Deductions',
                              'id' => 'update-otherd-' . $model->EmpID,
                              'data-toggle' => 'modal',
                              'data-target' => '#otherd-modals',
                              'data-id' => $key,
                              'data-pjax' => '0',
                              'onclick' => "ajaxmodal('#otherd-modal', '" . Url::to(['other-deductions/create-list','EmpID'=>$model->EmpID]) . "')"
                          ]
                      );
