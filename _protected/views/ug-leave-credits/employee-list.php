...
$this->title = 'Employee List for Under-Grad Leave Credits';
                ...
                'create' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="glyphicon glyphicon-plus"></span>',$url,
                          [
                              ...
                              'id' => 'update-ugl-' . $model->EmpID,
                              'data-toggle' => 'modal',
                              'data-target' => '#ugl-modals',
                              'data-id' => $key,
                              'data-pjax' => '0',
                              'onclick' => "ajaxmodal('#ugl-modal', '" . Url::to(['ug-leave-credits/create-list','EmpID'=>$model->EmpID]) . "')"
                          ]
                      );
