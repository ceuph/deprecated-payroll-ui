...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
 ...
 <?php $form = ActiveForm::begin(['id' => 'uglFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['ug-leave-credits/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['ug-leave-credits/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
