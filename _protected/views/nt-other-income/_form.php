...
<div class="nt-other-income-form">
    ...
    <?php $form = ActiveForm::begin(['id' => 'ntotherFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['nt-other-income/ajax-validate'])]); ?>
...
<?php
$url = Url::to(['nt-other-income/create']);
$script = <<< JS
...
$("#ntotherBtn").click(function(e){
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response == 1)
            {
                $('#ntotherFrm').trigger('reset');
                $.pjax.reload({container:'#ntotherTbl', async: false});
            }
        },
