...
$this->title = 'Employee List for Non-Teaching Other Income';
                ...
                'create' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="glyphicon glyphicon-plus"></span>',$url,
                          [
                              ...
                              'id' => 'update-nto-' . $model->EmpID,
                              'data-toggle' => 'modal',
                              'data-target' => '#nto-modals',
                              'data-id' => $key,
                              'data-pjax' => '0',
                              'onclick' => "ajaxmodal('#nto-modal', '" . Url::to(['nt-other-income/create-list','EmpID'=>$model->EmpID]) . "')"
                          ]
                      );
