...
$this->title = 'Employee List for Grad-School Leave Credits';
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'create' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="glyphicon glyphicon-plus"></span>',$url,
                          [
                              'title' => 'Add-Leave-Creadits',
                              'id' => 'update-gsl-' . $model->EmpID,
                              'data-toggle' => 'modal',
                              'data-target' => '#gsl-modals',
                              'data-id' => $key,
                              'data-pjax' => '0',
                              'onclick' => "ajaxmodal('#gsl-modal', '" . Url::to(['gs-leave-credits/create-list','EmpID'=>$model->EmpID]) . "')"
                          ]
                      );
