...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
    ...
    <?php $form = ActiveForm::begin(['id' => 'loansFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['loans/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['loans/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
