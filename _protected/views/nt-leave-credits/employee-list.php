...
$this->title = 'Employee List for Non-Teaching Leave Credits';
                ...
                'create' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="glyphicon glyphicon-plus"></span>',$url,
                          [
                              ...
                              'id' => 'update-nt-' . $model->EmpID,
                              'data-toggle' => 'modal',
                              'data-target' => '#nt-modals',
                              'data-id' => $key,
                              'data-pjax' => '0',
                              'onclick' => "ajaxmodal('#nt-modal', '" . Url::to(['nt-leave-credits/create-list','EmpID'=>$model->EmpID]) . "')"
                          ]
                      );
