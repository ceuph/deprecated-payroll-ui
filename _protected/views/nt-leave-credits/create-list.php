...
<h1><?= $employee->EmpID." - ".$employee->LName. ", ".$employee->FName ?></h1>
    ...
    <?php $form = ActiveForm::begin(['id' => 'ntFrm','enableAjaxValidation' => true,'validationUrl' => Yii::$app->urlManager->createUrl(['nt-leave-credits/ajax-validate-list','EmpID'=>$employee->EmpID])]); ?>
...
<?php
$url = Url::to(['nt-leave-credits/create-list','EmpID'=>$employee->EmpID]);
$script = <<< JS
